...
<img height="30px" style="float:left, margin-right:12px" src="https://github.com/deantendo/community/blob/master/ea_yes_exp_no.png?raw=true">
        </td>
    <tr>
</table>
<br /><hr />
...
Add 2 new storage with Awesome Sink integration sink them all!<br />
The storage needs power and only storage if they have power!<br />
The last slot will automatically sink if it is possible to sink!

<iframe width="560" height="315" src="https://www.youtube.com/embed/gIO8DOI5IIc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


<br /><hr />
## Credits:
- **Hailun** - Models, effects
<!-- **[Deantendo](https://ficsit.app/guide/5wQHZbwjYA2nJe)** - for the wonderful Mod icon > Deantendo
#4265-->
